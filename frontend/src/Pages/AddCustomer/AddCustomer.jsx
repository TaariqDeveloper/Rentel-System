        ...
        >
          ...
          <div className="p-4 md:p-6">
            ...
            <div className="flex mt-6 space-x-4 md:space-x-6">
              ...
              >
                <img src={image1} alt="Icon 1" className="w-8 h-8 md:w-10 md:h-10 rounded-full shadow-lg shadow-yellow-500" />
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                className="w-10 h-10 md:w-12 md:h-12 bg-white rounded-full flex items-center justify-center shadow-lg cursor-pointer animate-pulse"
              >
                <img src={image3} alt="Icon 2" className="w-8 h-8 md:w-10 md:h-10 rounded-full shadow-lg shadow-yellow-500" />
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
