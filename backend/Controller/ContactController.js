...
const createContact = async (req, res) => {
  try {
    ...
    // Emit event to admin when a new message is received
    if (ioInstance) {
      ioInstance.emit("newMessage", newContact);
    }
...
module.exports = { createContact, getContacts, deleteContact, setSocket };
